...
describe("helpers da comunicação",()=>{
 test("classifica retornos hoje, atrasados e futuros",()=>{const now=new Date("2026-08-09T12:00:00Z");assert.equal(followUpState("2026-08-09T14:00:00Z",now),"today");assert.equal(followUpState("2026-08-08T12:00:00Z",now),"overdue");assert.equal(followUpState("2026-08-10T12:00:00Z",now),"future")});
