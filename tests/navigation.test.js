  ...
  test("preserva os demais itens, rotas, grupos e status", () => {
    assert.deepEqual(
      ...
      [
        ...
        {
          to: "/advocacia/painel-juridico",
          label: "Painel Jurídico",
          ready: true,
          group: "operacao",
        },
        {
          to: "/advocacia/agenda-juridica",
        ...
        {
          to: "/saude/painel-faturamento",
          label: "Painel de Faturamento",
          ready: true,
          group: "gestao",
        },
