...
INSERT INTO public.client_portal_communication_shares(
  ...
  ('29500000-0000-0000-0000-000000000001', '39500000-0000-0000-0000-000000000001', '49500000-0000-0000-0000-000000000001', true, true, '2030-01-01 11:40:00+00'),
  ('29500000-0000-0000-0000-000000000001', '39500000-0000-0000-0000-000000000001', '49500000-0000-0000-0000-000000000002', true, true, '2030-01-01 11:20:00+00'),
...
INSERT INTO public.communication_entries(
  ...
  ('29500000-0000-0000-0000-000000000001', '49500000-0000-0000-0000-000000000001', 'mensagem', 'Preciso de ajuda', '19500000-0000-0000-0000-000000000003', '2030-01-01 11:40:00+00', false, '{"source":"client_portal"}'::jsonb),
  ('29500000-0000-0000-0000-000000000001', '49500000-0000-0000-0000-000000000002', 'mensagem', 'Meu prazo venceu', '19500000-0000-0000-0000-000000000003', '2030-01-01 11:20:00+00', false, '{"source":"client_portal"}'::jsonb),
...
SELECT is(
  (SELECT count(*) FROM public.notifications
    WHERE entity_id = '49500000-0000-0000-0000-000000000001'
      AND dedupe_key LIKE 'portal-sla:%'),
  3::bigint,
  'escalation reaches the responsible member and active management once'
);
