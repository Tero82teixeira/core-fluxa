...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/advocacia/painel-juridico", label: "Painel Jurídico", icon: Scale, description: "Carteira, prazos e prioridades jurídicas", ready: true, group: "operacao" },
  { to: "/advocacia/agenda-juridica", label: "Agenda Jurídica", icon: CalendarClock, description: "Audiências, prazos e tarefas jurídicas", ready: true, group: "operacao" },
  ...
  { to: "/saude/painel-clinica", label: "Painel da Clínica", icon: Activity, description: "Agenda, pendências e faturamento do dia", ready: true, group: "operacao" },
