...
export const MODULE_CATALOG: Array<{
  ...
  { key: "health_appointments", label: "Agenda e Atendimentos", description: "Horários, confirmações e responsáveis pelos atendimentos.", group: "health", available: true },
...
const ROUTE_MODULES: Record<string, ModuleKey> = {
  ...
  "/saude/painel-faturamento": "health_billing",
