...
function DataTable({ kind, rows, search, setSearch, page, setPage, exportRows }: { kind:string; rows:AnyRow[]; search:string; setSearch:(v:string)=>void; page:number; setPage:(v:number)=>void; exportRows:(k:string,r:AnyRow[])=>void }) {
