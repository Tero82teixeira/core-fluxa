Warning: truncated output (original token count: 62298)
Total output lines: 8020
  ...
  public: {
    Tables: {
      ...
      communication_macros: {
        ...
        Relationships: [
          {
            foreignKeyName: "communication_macros_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      documents: {
        ...
        Update: {
          ...
          reviewed_by?: string | null
          reviewed_by_name?: string | null
          status?: Database["public"]["Enums"]["…12298 tokens truncated…oolean | null
